...
<head>
    <meta charset="UTF-8">
    <link rel="icon" type="image/png" href="public/assets/LogoTren.PNG">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Consola de Control - Tren del Tayta Imbabura</title>
    <link rel="stylesheet" href="public/css/main.css">
    <link rel="stylesheet" href="public/css/login.css">
    <link rel="stylesheet" href="public/css/modals.css">
    <link rel="stylesheet" href="public/css/player-controls.css">
...
<body>
    ...
    <div class="app-container hidden">
        <header>
            <div class="logo">
                <img src="public/assets/LogoTren.PNG" alt="Logo Tren del Tayta Imbabura">
            </div>
